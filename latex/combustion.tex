...
Mathematicals models for predicting combustion phenomena stem from the compressible, reacting, Navier-Stokes equations~\cite{PoinsotVeynante3ed}. In absence
