...
$$pv = nRT$$ Where $p$ is the pressure, $v$ is the volume, $n$ is the number of moles of the gas, $R$ is the universal gas constant and $T$ is the tempaerature. The viscocoty of the species is given by the following formula
...
\noindent The Wilke formula for viscosity, independant of
...
\subfloat[Mixture Viscocity behind the flame\label{subfig-1:dummy}]{%
     \includegraphics[scale=0.5]{mixtureviscocty_behindflame.png} 
    }
\subfloat[Mixture Viscocity inside the flame\label{subfig-1:dummy}]{%
     \includegraphics[scale=0.5]{mixtureviscocty_insideflame.png} 
    }
    \quad
   \subfloat[Mixture Viscocity after the flame \label{subfig-1:dummy}]{%
        \includegraphics[scale=0.5]{mixtureviscocty_afterflame.png} 
       }
...
\subfloat[Mixture thermal conductivity behind the flame\label{subfig-1:dummy}]{%
     \includegraphics[scale=0.5]{mixturethermal_behindflame.png} 
    }
\subfloat[Mixture thermal conductivity inside the flame\label{subfig-1:dummy}]{%
     \includegraphics[scale=0.5]{mixturethermal_insideflame.png} 
    }
    \quad
   \subfloat[Mixture thermal conductivity after the flame \label{subfig-1:dummy}]{%
        \includegraphics[scale=0.5]{mixturethermal_afterflame.png} 
       }
